...
public class SmokeTestWithRandUnit extends RUJUnit4Case {
    ...
    public static Collection<StatementModel> data() {
        if (cache.isEmpty()) {
            ...
            scannerConfig.setExcludeFilter(new HashSet<String>() {{
                add("com.example.android.uamp.databinding.FragmentMediaitem");
                add("com.example.android.uamp.databinding.FragmentNowplayingBinding");
            }});
